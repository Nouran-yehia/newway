...
<head>
  ...
  />
    ...
    <link rel="stylesheet" href="{{url('/')}}/design/admin/https://fonts.googleapis.com/css?family=Source+Sans+Pro:300,400,400i,700&display=fallback">
    <!-- Font Awesome -->
    ...
    <link rel="stylesheet" href="{{url('/')}}/design/admin/plugins/fontawesome-free/css/all.min.css">
    <!-- Ionicons -->
   <!-- <link rel="stylesheet" href="{{url('/')}}/design/admin/https://code.ionicframework.com/ionicons/2.0.1/css/ionicons.min.css">-->
    ...
    <link rel="stylesheet" href="{{url('/')}}/design/admin/https://cdn.datatables.net/1.10.24/css/jquery.dataTables.min.css">
    <link rel="stylesheet" href="{{url('/')}}/design/admin/https://cdn.datatables.net/buttons/1.7.0/css/buttons.dataTables.min.css">
